...
public class YamlRefreshHelper {
  ...
  public JsonNode refreshNodeFromSourceNode(JsonNode nodeToRefresh, JsonNode sourceNode) {
    ...
    Map<String, JsonNode> dummySourceNodeSpecMap = new LinkedHashMap<>();
    dummySourceNodeSpecMap.put(DUMMY_NODE, sourceNode);
    String dummySourceNodeSpecYaml = convertToYaml(dummySourceNodeSpecMap);
    ...
    Map<String, JsonNode> dummyNodeToRefreshMap = new LinkedHashMap<>();
    dummyNodeToRefreshMap.put(DUMMY_NODE, nodeToRefresh);
    String dummyNodeToRefreshYaml = convertToYaml(dummyNodeToRefreshMap);
