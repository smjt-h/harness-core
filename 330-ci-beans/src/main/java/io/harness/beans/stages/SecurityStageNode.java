...
public class SecurityStageNode extends SecurityAbstractStageNode {
  @JsonProperty("type") @NotNull StepType type = StepType.Security;

  @JsonProperty("spec")
  @JsonTypeInfo(use = NAME, property = "type", include = EXTERNAL_PROPERTY, visible = true)
  SecurityStageConfig securityStageConfig;
  @Override
  ...
  public enum StepType {
    Security(StepSpecTypeConstants.SECURITY_STAGE);
    @Getter String name;
