...
@Slf4j
@OwnedBy(STO)
public class SecurityPmsPipelineYamlTest extends CiBeansTestBase {
  @Test
  ...
  public void testCiPipelineConversion() throws IOException {
    ...
    for (StageElementWrapperConfig stage : stages) {
      ...
      SecurityStageConfig stageConfig = (SecurityStageConfig) stageElementConfig.getStageType();
      if (stageConfig.getExecution() != null) {
        for (ExecutionWrapperConfig executionWrapperConfig : stageConfig.getExecution().getSteps()) {
