...
import io.harness.app.impl.SecurityStageYamlSchemaServiceImpl;
...
public class CIManagerServiceModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(SecurityStageYamlSchemaService.class).to(SecurityStageYamlSchemaServiceImpl.class).in(Singleton.class);
