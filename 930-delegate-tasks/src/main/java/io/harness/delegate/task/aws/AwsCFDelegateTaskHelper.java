...
public class AwsCFDelegateTaskHelper {
  ...
  private final AWSCloudformationClient awsApiHelperService;
  ...
  public DelegateResponseData getCFParamsList(AwsCFTaskParamsRequest awsTaskParams) {
    ...
    try {
      List<ParameterDeclaration> parameterDeclarationList = awsApiHelperService.getParamsData(awsInternalConfig,
          awsTaskParams.getRegion(), awsTaskParams.getData(), awsTaskParams.getFileStoreType(), gitFileContent);
