...
public class CloudformationCreateStackTaskHandler extends CloudformationAbstractTaskHandler {
  ...
  public CloudformationTaskNGResponse executeTaskInternal(
    ...
    awsS3DelegateTaskHelper.decryptRequestDTOs(
        taskNGParameters.getAwsConnector(), taskNGParameters.getEncryptedDataDetails());
    AwsInternalConfig awsInternalConfig =
        getAwsInternalConfig(taskNGParameters.getAwsConnector(), taskNGParameters.getRegion());
    ...
    if (!stackOptional.isPresent()) {
      ...
      if (StackStatus.ROLLBACK_COMPLETE.name().equals(stack.getStackStatus())) {
        ...
        CloudformationTaskNGResponse cloudformationTaskNGResponse =
            deleteStack(stack.getStackId(), stack.getStackName(), taskNGParameters, logCallback);
  ...
  private CloudformationTaskNGResponse createStack(CloudformationTaskNGParameters createStackParameters,
    ...
    CloudformationTaskNGResponse.CloudformationTaskNGResponseBuilder builder = CloudformationTaskNGResponse.builder();
  ...
  private void createStackAndWaitWithEvents(CloudformationTaskNGParameters createRequest,
      ...
      CloudformationTaskNGResponse.CloudformationTaskNGResponseBuilder builder, LogCallback logCallback) {
  ...
  private void updateStackAndWaitWithEvents(CloudformationTaskNGParameters request, AwsInternalConfig awsInternalConfig,
      UpdateStackRequest updateStackRequest, CloudformationTaskNGResponse.CloudformationTaskNGResponseBuilder builder,
      Stack originalStack, LogCallback logCallback) {
  ...
  private void populateCloudformationTaskNGResponse(
      CloudformationTaskNGResponse.CloudformationTaskNGResponseBuilder builder, Stack stack,
      ExistingStackInfo existingStackInfo) {
