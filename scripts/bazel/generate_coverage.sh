...
echo "Bazel Command: bazel coverage -s -k --java_toolchain=@bazel_tools//tools/jdk:toolchain_hostjdk11 --collect_code_coverage --combined_report=lcov --coverage_report_generator=@bazel_tools//tools/test:coverage_report_generator //${MODULE_NAME}/..."
bazel coverage -s -k --java_toolchain=@bazel_tools//tools/jdk:toolchain_hostjdk11 \
