...
public class CloudformationCreateStackStep
  ...
  public void validateResources(Ambiance ambiance, StepElementParameters stepParameters) {
    ...
    CloudformationTemplateFileSpec cloudformationTemplateFileSpec =
        cloudformationStepConfiguration.getConfiguration().getTemplateFile().getSpec();
    ...
    if (isNotEmpty(cloudformationStepConfiguration.getConfiguration().getParametersFilesSpecs())) {
      cloudformationStepConfiguration.getConfiguration().getParametersFilesSpecs().forEach(
  ...
  public StepResponse finalizeExecutionWithSecurityContext(Ambiance ambiance, StepElementParameters stepParameters,
    ...
    CloudformationTaskNGResponse cloudformationTaskNGResponse = null;
    try {
