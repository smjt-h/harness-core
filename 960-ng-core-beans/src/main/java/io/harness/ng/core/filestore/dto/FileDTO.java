...
public class FileDTO {
  ...
  @Schema(description = "File created by user") @FormDataParam("createdBy") private NGEmbeddedUserDTO createdBy;
  @Schema(description = "File updated by user") @FormDataParam("lastUpdatedBy") private NGEmbeddedUserDTO lastUpdatedBy;
  ...
  public FileDTO(String accountIdentifier, String orgIdentifier, String projectIdentifier, String identifier,
      ...
      String mimeType, Boolean draft, NGEmbeddedUserDTO createdBy, NGEmbeddedUserDTO lastUpdatedBy) {
