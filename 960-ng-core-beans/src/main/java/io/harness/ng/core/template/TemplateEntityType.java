...
public enum TemplateEntityType {
  ...
  @JsonProperty(TemplateEntityConstants.MONITORED_SERVICE)
  MONITORED_SERVICE(
      TemplateEntityConstants.MONITORED_SERVICE, MONITORED_SERVICE_ROOT_FIELD, asList(IDENTIFIER_KEY, NAME_KEY));
