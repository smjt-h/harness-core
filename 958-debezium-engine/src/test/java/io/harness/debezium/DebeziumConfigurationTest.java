...
public class DebeziumConfigurationTest {
  ...
  public void testGetDebeziumProperties() {
    ...
    expected_props.setProperty(DebeziumConfiguration.OFFSET_STORAGE, MongoOffsetBackingStore.class.getName());
    expected_props.setProperty(
        DebeziumConfiguration.OFFSET_STORAGE_FILE_FILENAME, debeziumConfig.getOffsetStorageFileName());
    expected_props.setProperty(DebeziumConfiguration.OFFSET_STORAGE_COLLECTION, DebeziumOffset.OFFSET_COLLECTION);
    expected_props.setProperty(
