...
@Slf4j
@OwnedBy(CDC)
public class ServiceV2RepositoryCustomImpl implements ServiceV2RepositoryCustom {
  ...
  public ServiceEntity update(ServiceEntity serviceEntity, Criteria criteria) {
    ...
    return gitAwarePersistence.save(
        serviceEntity, serviceEntity.getYaml(), ChangeType.MODIFY, ServiceEntity.class, supplier);
  }
