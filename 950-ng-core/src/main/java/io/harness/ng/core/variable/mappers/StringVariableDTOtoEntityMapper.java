...
public class StringVariableDTOtoEntityMapper implements VariableDTOToEntityMapper<StringVariableDTO, StringVariable> {
  @Override
  public StringVariable toVariableEntity(StringVariableDTO variableConfigDTO) {
