...
plain_artifacts = [
    ...
    "com.azure:azure-core-management:1.3.0",
    "com.azure.resourcemanager:azure-resourcemanager:2.13.0",
    ...
    "io.dropwizard:dropwizard-jackson:2.0.28",
    ...
    "io.swagger:swagger-annotations:1.6.4",
    "io.swagger:swagger-core:1.6.4",
    "io.swagger:swagger-jaxrs:1.6.4",
    "io.swagger:swagger-jersey2-jaxrs:1.6.4",
    "io.swagger:swagger-models:1.6.4",
...
maven_install(
    ...
    artifacts = plain_artifacts + amazon_artifacts + powermock_artifacts + [
        ...
        maven_test_artifact("com.squareup.okhttp3:mockwebserver:4.9.0"),
