...
public class GitChangeSetRunnableTest extends GitSyncTestBase {
  ...
  public void testRun_1() {
    ...
    assertThat(argumentCaptor.getAllValues().stream().anyMatch(yamlChangeSet -> yamlChangeSet.getEventType().equals(YamlChangeSetEventType.BRANCH_SYNC)));
    assertThat(argumentCaptor.getAllValues().stream().anyMatch(yamlChangeSet -> yamlChangeSet.getEventType().equals(YamlChangeSetEventType.BRANCH_PUSH)));
  }
}
