...
public class GithubCreatePullRequestScmApiErrorHandler implements ScmApiErrorHandler {
  ...
  public void handleError(int statusCode, String errorMessage) throws WingsException {
    switch (statusCode) {
      ...
      case 404:
        throw NestedExceptionUtils.hintWithExplanationException(SCMExceptionHints.CREATE_PULL_REQUEST_NOT_FOUND_ERROR,
            SCMExceptionExplanations.CREATE_PULL_REQUEST_NOT_FOUND_ERROR,
