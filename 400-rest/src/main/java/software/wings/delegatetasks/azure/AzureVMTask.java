...
public class AzureVMTask extends AbstractDelegateRunnableTask {
  // TODO - Arvind
  ...
  public AzureVMTask(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
