...
public class NGTriggerElementMapperV2Test extends CategoryTest {
  ...
  private String ngTriggerYaml_artifact_artifactoryregistry;
  ...
  public void setUp() throws IOException {
    ...
    ngTriggerYaml_artifact_dockerregistry =
        Resources.toString(Objects.requireNonNull(classLoader.getResource("ng-trigger-artifact-dockerregistry.yaml")),
            StandardCharsets.UTF_8);
    ngTriggerYaml_artifact_artifactoryregistry =
  ...
  @Category(UnitTests.class)
  public void testArtifactArtifactoryRegistry() throws Exception {
    NGTriggerConfigV2 ngTriggerConfigV2 =
            ngTriggerElementMapper.toTriggerConfigV2(ngTriggerYaml_artifact_artifactoryregistry);
