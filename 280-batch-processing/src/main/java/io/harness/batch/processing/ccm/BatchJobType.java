...
public enum BatchJobType {
  ...
  AWS_ECS_SERVICE_RECOMMENDATION(130, 20, ChronoUnit.MINUTES, emptyList(), OUT_OF_CLUSTER_ECS),
  DEPLOYMENT_EVENT(150, 1, ChronoUnit.DAYS, emptyList(), IN_CLUSTER),
  K8S_EVENT(300, 1, ChronoUnit.HOURS, emptyList(), IN_CLUSTER),
  DELEGATE_HEALTH_CHECK(310, 10, ChronoUnit.MINUTES, emptyList(), IN_CLUSTER),
