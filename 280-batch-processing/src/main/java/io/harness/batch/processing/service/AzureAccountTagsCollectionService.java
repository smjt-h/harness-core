...
public class AzureAccountTagsCollectionService {
  ...
  public void processAndInsertTags(CEAzureConnectorDTO ceAzureConnectorDTO, Account account) {
    ...
    log.info("Processing tags for azureTenantID: {} azureSubscriptionId: {}",
    ...
    try {
      log.info("clientid {}, clientsecret {}", azureStorageSyncConfig.getAzureAppClientId(),
      ...
      ResourceManager azure = ResourceManager.configure()
