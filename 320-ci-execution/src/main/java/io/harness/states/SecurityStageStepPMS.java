...
public class SecurityStageStepPMS implements ChildExecutable<StageElementParameters> {
  ...
  public ChildExecutableResponse obtainChild(
    ...
    log.info("Executing security stage with params accountId {} projectId {} [{}]", accountId, projectIdentifier,
        stepParameters);

    SecurityStageStepParametersPMS securityStageStepParametersPMS =
        (SecurityStageStepParametersPMS) stepParameters.getSpecConfig();

    Infrastructure infrastructure = securityStageStepParametersPMS.getInfrastructure();
    ...
    StageDetails stageDetails =
        StageDetails.builder()
            ...
            .buildStatusUpdateParameter(securityStageStepParametersPMS.getBuildStatusUpdateParameter())
    ...
    final String executionNodeId = securityStageStepParametersPMS.getChildNodeID();
  ...
  public StepResponse handleChildResponse(
    ...
    log.info("Executed security stage {} in {} milliseconds with status {} ", stepParameters.getIdentifier(),
    ...
    List<String> stepIdentifiers = securityStageStepParametersPMS.getStepIdentifiers();
