...
public class ECSRecommendationDAO {
  ...
  public List<ECSPartialRecommendationHistogram> fetchPartialRecommendationHistograms(
      @NonNull String accountId, @NonNull String clusterId, @NonNull String clusterName, @NonNull String serviceName,
      @NonNull String serviceArn, @NonNull Instant startTime, @NonNull Instant endTime) {
    return hPersistence.createQuery(ECSPartialRecommendationHistogram.class)
        ...
        .filter(ECSPartialRecommendationHistogramKeys.clusterName, clusterName)
        .filter(ECSPartialRecommendationHistogramKeys.serviceName, serviceName)
  ...
  public ECSServiceRecommendation fetchServiceRecommendation(@NonNull String accountId, @NonNull String clusterId,
      @NonNull String clusterName, @NonNull String serviceName, @NonNull String serviceArn) {
    return Optional
        .ofNullable(hPersistence.createQuery(ECSServiceRecommendation.class)
            ...
            .filter(ECSPartialRecommendationHistogramKeys.serviceArn, serviceArn)
            .get())
        .orElseGet(() -> ECSServiceRecommendation.builder()
            .accountId(accountId)
            .clusterId(clusterId)
