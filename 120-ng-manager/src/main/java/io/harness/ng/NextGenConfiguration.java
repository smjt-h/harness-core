...
public class NextGenConfiguration extends Configuration {
  ...
  public static final String VARIABLE_PACKAGE = "io.harness.ng.core.variable.resources";
    ...
    return HarnessReflections.get()
        ...
        .filter(klazz
            -> StringUtils.startsWithAny(klazz.getPackage().getName(), CORE_PACKAGE, CONNECTOR_PACKAGE,
                ...
                ENV_GROUP_RESOURCE, AZURE_RESOURCES_PACKAGE, NG_TRIAL_SIGNUP_PACKAGE, VARIABLE_PACKAGE))
