...
public class HostValidationResource {
    ...
    validateSshHost(@Parameter(description = ACCOUNT_PARAM_MESSAGE) @QueryParam(
            NGCommonEntityConstants.ACCOUNT_KEY) @NotNull String accountIdentifier,
                    ...
                    @Parameter(description = "Secret Identifier") @QueryParam(NGCommonEntityConstants.IDENTIFIER_KEY) @NotNull String secretIdentifier,
                    @Parameter(description = "Max num of hosts to test") @QueryParam("limit") Integer limit,
                    @RequestBody(required = true, description = "List of host names to validate") @NotNull List<String> hostNames) {

        return ResponseDTO.newResponse(
                hostValidationService.validateSSHHosts(
                        hostNames,
                        accountIdentifier,
                        orgIdentifier,
                        projectIdentifier,
