...
public class DelegateTasksBeansKryoRegister implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(CloudformationTaskNGParameters.class, 543481);
    kryo.register(CloudformationCommandUnit.class, 543482);
    kryo.register(CloudformationTaskType.class, 543483);
    kryo.register(CloudformationTaskNGResponse.class, 543484);
    kryo.register(CloudFormationCreateStackNGResponse.class, 543485);
    kryo.register(CloudFormationCommandNGResponse.class, 543486);
    kryo.register(AwsS3FetchFileDelegateConfig.class, 543487);
    kryo.register(AwsS3FetchFilesResponse.class, 543488);
    kryo.register(AwsS3FetchFilesTaskParams.class, 543489);
    kryo.register(S3FileDetailRequest.class, 543490);
    kryo.register(S3FileDetailResponse.class, 543491);
  }
}
