...
public class YamlPathUtils {
  ...
  private static Map<String, Object> getValueFromArray(
  ...
  private static Map<String, Object> getValueFromObject(
      YamlNode yamlNode, Map<String, Map<String, Object>> fqnToValueMap, List<String> fqnList) {
    Map<String, Object> contextMap = new HashMap<>();
  ...
  private static List<Object> getListOfPrimitiveTypes(YamlNode yamlNode) {
