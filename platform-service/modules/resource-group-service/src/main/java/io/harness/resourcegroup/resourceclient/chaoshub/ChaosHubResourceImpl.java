...
package io.harness.resourcegroup.resourceclient.chaoshub;
...
@Slf4j
public class ChaosHubResourceImpl implements Resource {
  @Override
  ...
  public Optional<String> getEventFrameworkEntityType() {
    return Optional.of(EventsFrameworkMetadataConstants.CHAOS_HUB);
  }
  ...
  public Map<ScopeLevel, EnumSet<ValidatorType>> getSelectorKind() {
    return return ImmutableMap.of(ScopeLevel.ACCOUNT, EnumSet.of(BY_RESOURCE_TYPE_INCLUDING_CHILD_SCOPES),
